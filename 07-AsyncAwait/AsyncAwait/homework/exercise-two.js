...
async function problemA () {
  ...
  */
  ...
  // AsyncAwait version
  await Promise.all([ anton('poem-two/stanza-01.txt'), anton('poem-two/stanza-02.txt')])
  console.log('done')
}
...
*/
  // AsyncAwait version
    const promesas=filenames.map( f =>  anton(f))
